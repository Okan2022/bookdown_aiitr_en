...
```{r histogram with rescaled x-axis}
ggplot(data1, aes(x = value)) + 
...
```{r histogram with theme, message = FALSE, warning=FALSE}
ggplot(data1, aes(x = value)) + 
  geom_histogram(color = "white", fill = "#69b3a2") + 
  labs( 
    x = "Value", 
